...
CONDITION_FORECAST_CLASSES = {
    ATTR_CONDITION_PARTLYCLOUDY: [1380, 1381, 1375, 1376, 1387, 1388],
    ATTR_CONDITION_CLOUDY: [1386, 1374],
    ATTR_CONDITION_FOG: [1420],
    ATTR_CONDITION_HAIL: [1417, 1418],
    ATTR_CONDITION_LIGHTNING: [],
    ATTR_CONDITION_LIGHTNING_RAINY: [1389, 1390, 1391, 1392, 1393, 1394, 1395, 1396, 1397],
    ATTR_CONDITION_POURING: [1379, 1384, 1385],
    ATTR_CONDITION_RAINY: [1377, 1382, 1383, 1378],
    ATTR_CONDITION_SNOWY: [1398, 1399, 1401, 1402, 1405, 1406, 1407, 1408, 1409, 1410, 1411, 1412],
    ATTR_CONDITION_SNOWY_RAINY: [1413, 1414, 1415, 1419],
    ATTR_CONDITION_SUNNY: [1372, 1373],
    ATTR_CONDITION_WINDY: [1424, 1425],
    ATTR_CONDITION_WINDY_VARIANT: [],
    ATTR_CONDITION_EXCEPTIONAL: [],
}
